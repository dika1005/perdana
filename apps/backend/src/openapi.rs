...
#[openapi(
    ...
    components(
        schemas(
            ...
            ReportDateQuery, MonthlyReportQuery, MonthlySalesReportItem, DashboardSummaryResponse, DailySalesReportItem, TopProductReportItem,
