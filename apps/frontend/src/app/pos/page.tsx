        ...
        <div className="flex-1 flex flex-col h-full min-w-0">
          ...
          <div className="flex flex-col sm:flex-row gap-3 mb-4">
            ...
            <button 
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 font-bold rounded-xl bg-gradient-to-r from-amber-500/15 via-brand-500/15 to-purple-500/15 border border-amber-500/30 text-amber-700 dark:text-amber-300 text-xs hover:shadow-md transition-all shrink-0"
              title="Paste teks WhatsApp pesanan dan biarkan AI mengisi otomatis"
            >
              <Sparkles className="w-4 h-4 text-amber-500 animate-pulse" />
              <span>✨ AI Smart Order (WhatsApp)</span>
            </button>
          </div>
