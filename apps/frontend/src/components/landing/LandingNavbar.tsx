    ...
    <header className="sticky top-0 z-40 backdrop-blur-xl bg-white/80 dark:bg-[#090D16]/80 border-b border-slate-200/80 dark:border-slate-800/80 transition-colors">
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 py-3.5 sm:py-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3.5 group">
          <div className="relative w-10 h-10 rounded-2xl bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center text-white font-extrabold text-lg shadow-lg shadow-blue-500/25 group-hover:scale-105 transition-transform duration-200">
            <span>P</span>
          ...
          <div>
            ...
            <span className="text-[11px] text-slate-500 dark:text-slate-400 font-medium block mt-0.5">
              Digital Printing, Sablon, Offset & Konveksi
            </span>
          </div>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-8 text-xs font-bold text-slate-600 dark:text-slate-300">
          ...
          <Link 
            href="/cek-pesanan"
            className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800/90 hover:bg-blue-50 dark:hover:bg-blue-950/50 text-slate-700 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 border border-slate-200 dark:border-slate-700 transition-[background-color,color,border-color] duration-200 group"
          >
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="w-9 h-9 rounded-xl bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-700 dark:text-slate-200 transition-[background-color,color,transform,box-shadow,border-color] hover:scale-105 active:scale-95 cursor-pointer"
          ...
          <Link 
            href="/login" 
            className="shimmer-btn flex items-center gap-2 px-4 py-2 text-xs font-bold rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-md shadow-blue-500/25 active:scale-95 transition-[background-color,color,transform,box-shadow,border-color]"
          >
